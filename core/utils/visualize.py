...
def get_color_pallete(npimg, dataset='pascal_voc'):
    ...
    if dataset == 'ade20k':
        ...
        return out_img
    if dataset =='whu_satellite':
        npimg[npimg == 1] = 255
    if dataset =='whu_little':
        npimg[npimg == 1] = 255
    if dataset =='whu_aerial':
        npimg[npimg == 1] = 255
    if dataset =='inria':
        npimg[npimg == 1] = 255
    elif dataset == 'citys':
...
def get_color_pallete_sig(npimg, dataset='pascal_voc'):
    ...
    if dataset == 'ade20k':
        ...
        return out_img
    if dataset =='bcdd':
        npimg[npimg == True] = 255
        npimg[npimg == False] = 0
    if dataset =='aerial_data':
        npimg[npimg == 1] = 255
    if dataset =='inria':
        npimg[npimg == 1] = 255
    elif dataset == 'citys':
