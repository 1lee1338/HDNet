...
class InriaSegmentation(object):
    ...
    def __init__(self, root='/XXXXX/', split='train', mode=None, base_size=256,crop_size=256):
        ...
        self.transform = transforms.Compose([
            transforms.ToTensor(),
            # transforms.Normalize([.401, .426, .391], [.191, .175, .163]),#inria
        ])
        ...
        self.test_transform = transforms.Compose([
            transforms.ToTensor(),
            # transforms.Normalize([.407, .427, .394], [.167, .153, .146]),#inria
        ])
